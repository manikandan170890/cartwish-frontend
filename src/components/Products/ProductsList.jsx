...
const ProductsList = () => {
  ...
  */
  ...
  // const page = search.get("page"); // pagination
  ...
  const handlePageChange = (page) => {
    ...
    // setSearch({ ...currentParams, page: page }); // pagination
    setSearch({ ...currentParams, page: parseInt(currentParams.page) + 1 }); //Infinite scroll (news feed)
  };
